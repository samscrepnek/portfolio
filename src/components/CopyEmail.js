...
const CopyEmail = () => {
  ...
  return (
    <button onClick={copyEmailToClipboard} className="email-btn">
      {!emailCopied ? (
        <svg clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" width="25" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
