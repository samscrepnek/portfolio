    ...
    <nav className="top-nav">
      <ul>
        <ul className="top-nav-inner-wrapper">
          ...
          <li>
            <button aria-label="Open menu" className="menu-icon" onClick={toggleMenu}>
        ...
        <div className="nav-menu-container hidden">
          <div className="nav-menu-wrapper">
            <button aria-label="Close menu" className="close-icon" onClick={toggleMenu}>
            ...
            <menu className="nav-menu">
              <li>
                <NavLink aria-label="Link to home page" to="/" onClick={toggleMenu}>
                  Home
                </NavLink>
              </li>
              <li>
                <NavLink aria-label="Link to about page" to="/about" onClick={toggleMenu}>
                  About
                </NavLink>
              </li>
              <li>
